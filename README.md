# 11.IMPLEMENTATION-OF-HUFFMAN-CODING-
## Aim
...
## program
```
input_string = "YASWANTH V(212225220125)"  # Example input string
frequency = {}
...
print("Character |YASWANTH V(212225220125) ")
print("-------------------------")
...
## Output
<img width="416" height="400" alt="image" src="https://github.com/user-attachments/assets/3459893b-2f66-45e7-a571-18c5ffeaf1c9" />
